...
public class ApiManager : MonoBehaviour
{
    ...
    [Header("서버 설정")]
    private string baseUrl = "https://memorix-api-production.up.railway.app";
    ...
    /// <summary>온보딩 퀴즈 문제를 가져옵니다.</summary>
    public IEnumerator GetOnboardingQuiz(Action<OnboardingQuiz> onSuccess, Action<string> onError = null)
    {
        yield return GetRequest<OnboardingQuiz>($"/api/onboarding/quiz?user_id={UserId}", onSuccess, onError);
    }
    ...
    {
        var payload = new QuizAnswerPayload { user_id = UserId, answers = answers };
